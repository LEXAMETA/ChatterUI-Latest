...
// Default in case selectorData is empty
const defaultSelectorItem = { label: '', value: '' }
  ...
  return (
    ...
    >
      ...
      <ThemedSlider
        ...
        label="Test Slider"
      />
      <ThemedTextInput label="Test Text" value={textInputData} onChangeText={setTextInputData} />
      <DropdownSheet
        data={selectorData}
        selected={selected}
