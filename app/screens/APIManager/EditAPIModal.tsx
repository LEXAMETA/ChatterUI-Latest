          ...
          {template.ui.editableCompletionPath && (
            <View>
              <ThemedTextInput
                ...
                onChangeText={(val: string) => setValues({ ...values, endpoint: val })}
              />
          ...
          {template.ui.editableModelPath && (
            <View>
              <ThemedTextInput
                ...
                onChangeText={(val: string) => setValues({ ...values, modelEndpoint: val })}
              />
              <HeartbeatButton
                ...
                headers={
                  template.features.useKey
                    ? { [template.request.authHeader]: template.request.authPrefix + values.key }
                    : {}
                }
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', columnGap: 8 }}>
                {!template.features.multipleModels ? (
                  <DropdownSheet
                    ...
                    data={modelList}
                    labelExtractor={(v) => getNestedValue(v, template.model.nameParser)}
          ...
          {template.features.useFirstMessage && (
            <View>
              <ThemedTextInput
                ...
                onChangeText={(val: string) => setValues({ ...values, firstMessage: val })}
              />
          ...
          {template.features.usePrefill && (
            <View>
              <ThemedTextInput
                ...
                onChangeText={(val: string) => setValues({ ...values, prefill: val })}
              />
